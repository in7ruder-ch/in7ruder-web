          ...
          {Array.from({ length: 3 }).map((_, i) => (
            ...
            >
              ...
              <div className="mt-auto pt-6">
                <a
                  href="#"
                  className="inline-flex w-full items-center justify-center rounded-full bg-white px-4 py-2 text-sm font-semibold text-zinc-950 hover:bg-zinc-200 transition"
                >
                  Live / Repo
                </a>
              </div>
