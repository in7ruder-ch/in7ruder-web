    ...
    <footer className="border-t border-[var(--line)] bg-[var(--paper)] text-[var(--ink)]">
      <div className="page-wrap py-10">
        <div className="flex flex-col items-center justify-center gap-5 sm:flex-row sm:gap-8">
          <a href="mailto:matias@in7ruder.com" className="footer-link inline-flex items-center gap-2.5 text-sm" aria-label={copy.email}>
          ...
          <a href="https://www.linkedin.com/in/mvanarelli/" target="_blank" rel="noreferrer" className="footer-link inline-flex items-center gap-2.5 text-sm" aria-label={copy.linkedin}>
