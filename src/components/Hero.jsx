      ...
      <div className="grid gap-10 md:grid-cols-12 items-start">
        ...
        <div className="md:col-span-7 space-y-6">
          <p className="text-sm text-zinc-400">
            Security-driven delivery for modern teams
          </p>

          <h1 className="text-4xl md:text-6xl font-semibold tracking-tight leading-[1.05]">
            Build web apps that ship fast{" "}
          ...
          <p className="text-lg text-zinc-300 max-w-xl">
            Secure full-stack development aligned with OWASP AppSec guidance 
            plus corporate social engineering training and pentesting to
        ...
        <div className="md:col-span-5">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm text-zinc-300">
              ...
              <li className="flex gap-3">
                <span className="mt-1 h-1.5 w-1.5 rounded-full bg-white/70" />
                Security-first defaults (auth, input validation, secrets)
              </li>
              <li className="flex gap-3">
                <span className="mt-1 h-1.5 w-1.5 rounded-full bg-white/70" />
            ...
            <div className="mt-6 rounded-xl border border-white/10 bg-zinc-950/40 p-4">
              ...
              <p className="mt-2 text-sm text-white">
                Secure MVP • AppSec Hardening • Pentest & Retest • Awareness +
                Simulation
              </p>
            </div>
          </div>
